...
export default function AdminProducts() {
  ...
  async function load() {
    setLoading(true)
    try {
      const res = await endpoints.admin.products.list()
      const d = res.data
  ...
  async function handleSubmit(e) {
    ...
    try {
      const payload = { name: form.name, description: form.description, price: form.price, category: form.category, stock: form.stock, image_url: form.imageUrl }
  ...
  function openEdit(item) {
    setForm({ name: item.name, description: item.description || '', price: item.price || '', category: item.category || '', stock: item.stock ?? '', imageUrl: item.image_url || item.imageUrl || '', image_file: null })
